...
const val SERVICE_KEY = "7O6jz/WpnA9lp2n3YIOmEpAAQfU1wegfAbbsGUYS/IvLI4+W+TvfU8OLmXCSL0BRIkZXoZxa6ha+6bBLV5wUbw==";
...
data class WeatherItem(val baseDate:String, val baseTime:String, val category:String,
...
data class WeatherBody(val dataType:String, val items: WeatherItems, val pageNo:Int, val numOfRows:Int, val totalCount:Int)
...
private fun requestWeatherApi(baseDate:String, baseTime:String, action:(Boolean, WeatherResult?, Throwable?)->Unit) {
//    Log.i("hong", "baseDate:$baseDate , baseTime:$baseTime")
